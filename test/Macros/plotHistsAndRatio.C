...
TCanvas* plotHistsAndRatio(vector<TH1F*> numeratorHistograms, TH1F* denominatorHist, TString title="", TString xTitle="", TString yTitle="") {
  ...
  hist_over_denomHist[0]->SetLineColor(kBlack); //Made default black
  ...
  hist_over_denomHist[0]->GetXaxis()->SetTitleSize(0.12);
  hist_over_denomHist[0]->GetXaxis()->SetLabelSize(0.12);
  hist_over_denomHist[0]->GetXaxis()->SetTitleOffset(1.1);
  hist_over_denomHist[0]->GetYaxis()->SetLabelSize(0.10);
  ...
  denominatorHistogram->GetYaxis()->SetLabelSize(0.06);
  denominatorHistogram->GetYaxis()->SetTitleSize(0.07);
  denominatorHistogram->GetYaxis()->SetTitleOffset(0.6);
  ...
  leg->AddEntry(hists[0],"LM3=50");
  leg->AddEntry(denominatorHistogram,"LM3=0");
  leg->Draw();
  //c1_2->SetLogx(1);
